...
function Profile() {
    ...
    data in database by api for new update: */
    useEffect(() => {
        ...
        <section>
            ...
            <form className={styles.profile_container} onSubmit={handleSubmit}>
                    ...
                    <Input text="E-mail" type="email" name="email"
                        placeholder="Seu e-mail" handleOnChange={handleChange} value={user.email || ''} />

                    <Input text="Nome" type="text" name="name"
                        placeholder="Seu nome" handleOnChange={handleChange} value={user.name || ''} />

                    <Input text="Telefone" type="tel" name="phone"
                        placeholder="Seu telefone" handleOnChange={handleChange} value={user.phone || ''} />

                    <Input text="Senha" type="password" name="password"
                        placeholder="Sua nova senha" handleOnChange={handleChange} />

                    <Input text="Confirmação de senha" type="password" name="confirmPassword"
                        placeholder="Digite novamente sua nova senha" handleOnChange={handleChange} />
